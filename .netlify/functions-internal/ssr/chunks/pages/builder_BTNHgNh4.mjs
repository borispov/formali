import { c as createAstro, d as createComponent, r as renderTemplate, e as addAttribute, f as renderSlot, g as renderHead, h as renderComponent } from '../astro_DLZz2DHT.mjs';
/* empty css                          */
/* empty css                            */
import 'kleur/colors';
import 'html-escaper';
...
const $$Builder = createComponent(async ($$result, $$props, $$slots) => {
  ...
  Astro2.self = $$Builder;
  return renderTemplate`${renderComponent($$result, "Layout", $$Layout, { "title": "builder" }, { "default": ($$result2) => renderTemplate` ${renderComponent($$result2, "Builder", null, { "client:only": "svelte", "client:component-hydration": "only", "client:component-path": "/Users/rispov/Developer/formali/src/components/SvelteForm/Builder.svelte", "client:component-export": "default" })} ` })}`;
