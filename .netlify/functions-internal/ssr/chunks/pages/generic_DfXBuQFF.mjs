...
import { A as AstroError, I as InvalidImageService, i as isRemoteImage, a as isESMImportedImage, b as isLocalService, D as DEFAULT_HASH_PROPS, c as isRemoteAllowed } from '../astro/assets-service_D45lnG-K.mjs';
import { A as AstroError$1, e as ExpectedImageOptions, E as ExpectedImage, F as FailedToFetchRemoteImageDimensions, f as InvalidImageService$1, c as createAstro, d as createComponent, g as ImageMissingAlt, r as renderTemplate, m as maybeRenderHead, h as addAttribute, s as spreadAttributes } from '../astro_D5rWRlKh.mjs';
import 'html-escaper';
import 'clsx';
...
async function getConfiguredImageService$1() {
  if (!globalThis?.astroAsset?.imageService) {
    const { default: service } = await import(
      // @ts-expect-error
      '../astro/assets-service_D45lnG-K.mjs'
    ).then(n => n.s).catch((e) => {
