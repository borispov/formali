    ...
    {#each forms as form}
        <div class="card hover:shadow-lg hover:bg-teal-300">
            ...
            >
                ...
                <h3
                    onclick={(e) =>
                        (window.location.href = `/builder?form=${form.id}`)}
                    class="cursor-pointer card-title text-center"
                >
                    {form.name}
                </h3>
                ...
                <div class="flex justify-between items-center w-full">
                    <div class="dropdown dropdown-end">
                        ...
                        >
                            <div class="indicator">
                                <div
                                    class="i-mdi:dots-vertical w-1.5rem h-1.5rem"
                                ></div>
                            </div>
                        </div>
                        ...
                        <!-- Sub-Menu -->
                        <div
                            class="mt-3 z-[1] card card-compact dropdown-content w-52 sshadow p2 bg-base-100 rounded-t-none"
                        >
                            <div class="card-body flex-col flex gap-4">
                                <button
                                    class="flex items-center gap-2"
                                    onclick={() =>
                                        showToast(window, "קישור לטופס הועתק")}
                                >
                                    <div
                                        class="i-mdi:share w-1.8rem h-1.8rem"
                                    ></div>
                                ...
                                <button
                                    class="flex items-center gap-2"
                                    href="#"
                                    onclick={() => removeHandler(form.id)}
                                >
                                    <div class="i-mdi:trash w-1.8rem h-1.8rem">
                                        הסר
                                    </div>
