  ...
  onMount(() => {
    editor = new Editor({
      ...
      editorProps: {
        attributes: {
          class:
            "prose dark:prose-invert prose-sm sm:prose-base lg:prose-lg xl:prose-2xl p-4 focus:outline-2 outline-gray-600",
        },
      },
      autofocus: true,
      content: `<p>${value}</p>`,
...
{#if editor}
  <div
    id="toolbox"
    class={`${state.showToolbox ? "flex" : "hidden"} flex-wrap items-center p-2 text-xs bg-gray-100 border border-b-0 border-gray-200 rounded rounded-b-none relative`}
  >
    <div class="ml-2 text-center lg:ml-5">
      ...
      >
        <div class="i-mdi:format-bold h-6 w-6"></div>
      </button>
    </div>
    <div class="ml-2 text-center lg:ml-5">
      <button
      ...
      >
        <div class="i-mdi:format-italic h-6 w-6"></div>
      </button>
    </div>
    <div class="ml-2 text-center lg:ml-5">
      <button
      ...
      >
        <div class="i-mdi:format-underline h-6 w-6"></div>
      </button>
    </div>
    ...
    <div class="ml-2 text-center lg:ml-5">
      ...
      <button onclick={handleLink} class:active={editor.isActive("link")}>
        <div class="i-mdi:link-box h-6 w-6"></div>
      </button>
    </div>
    ...
    <div class="ml-2 text-center lg:ml-5">
      ...
      >
        <div class="i-mdi:youtube h-6 w-6"></div>
      </button>
    </div>
  </div>
